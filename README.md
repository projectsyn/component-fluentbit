# Commodore Component: fluentbit

This is a [Commodore][commodore] Component for fluentbit.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/fluentbit).
